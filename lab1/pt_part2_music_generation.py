...
Original file is located at
    https://colab.research.google.com/github/MITDeepLearning/introtodeeplearning/blob/master/lab1/PT_Part2_Music_Generation.ipynb
...
def vectorize_string(string):
  return np.array([char2idx[ch] for ch in string], dtype=np.int32)
...
class LSTMModel(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_size):
        ...
        self.lstm = nn.LSTM(input_size=embedding_dim, hidden_size=hidden_size, batch_first=True) # TODO
...
def generate_text(model, start_string, generation_length=1000):
  ...
  input_idx = [char2idx[ch] for ch in start_string] # TODO
  ...
  for i in tqdm(range(generation_length)):
    ...
    predicted_id = input_idx.item()
    # Hint: consider what format the prediction is in vs. the output
    text_generated.append(idx2char[predicted_id])

    # Prepare input for the next step (keep shape [1,1])
...
generated_text = generate_text(model, "X:1\nT:Generated Song\nM:4/4\nK:C\n", 1000) # TODO
