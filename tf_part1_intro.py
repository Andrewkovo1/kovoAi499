...
Original file is located at
    https://colab.research.google.com/github/MITDeepLearning/introtodeeplearning/blob/master/lab1/TF_Part1_Intro.ipynb
...
class OurDenseLayer(tf.keras.layers.Layer):
  ...
  def call(self, x):
    ...
    z1 = tf.matmul(x, self.W)
    z = tf.add(z1, self.b)# TODO
...
class IdentityModel(tf.keras.Model):
  ...
  def call(self, inputs, isidentity=False):
    if isidentity:
        ...
        return self.dense_layer(inputs) ### TODO
