...
Original file is located at
    https://colab.research.google.com/github/MITDeepLearning/introtodeeplearning/blob/master/lab2/TF_Part2_Debiasing.ipynb
...
def vae_loss_function(x, x_recon, mu, logsigma, kl_weight=0.0005):
  ...
  latent_loss = 0.5 * tf.reduce_sum(tf.exp(logsigma) + tf.square(mu) - 1 - logsigma, axis=1)# TODO
...
def sampling(z_mean, z_logsigma):
  ...
  z = z_mean + tf.exp(0.5 * z_logsigma) * epsilon# TODO
