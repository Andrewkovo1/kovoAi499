...
Original file is located at
    https://colab.research.google.com/github/MITDeepLearning/introtodeeplearning/blob/master/lab1/TF_Part2_Music_Generation.ipynb
...
example_batch_loss = compute_loss(y_batch, pred[:y_batch.shape[0], :y_batch.shape[1], :]) # TODO
...
generated_text = generate_text(model, start_string="X:1\nT:Generated Song\nM:4/4\nK:C\nCDEFGAB|", generation_length=1000)

# Print the first 1000 characters of the generated text
